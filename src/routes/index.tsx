      ...
      <section className="bg-stone/60 py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-12 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            ...
            <div className=" mt-3 inline-flex items-center gap-2 self-start rounded-full border border-charcoal/10 bg-ivory px-3.5 py-1.5">
              <svg
                className="h-4 w-4"
                viewBox="0 0 24 24"
                fill="none"
              ...
              <span className="text-xs font-medium tracking-wide text-charcoal/80">
                Google reviews
              </span>
            </div>
          </div>
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <figure className="bg-stone/70 p-8">
              <blockquote className="font-serif text-lg leading-snug text-charcoal">
                "Absolutely delighted with our new loft"
              </blockquote>
